		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MyFirstApp",
									"targetURL": "#testfirstappfirstapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testfirstappfirstapp-display": {
								"semanticObject": "testfirstappfirstapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.first.app.firstapp",
									"url": sap.ui.require.toUrl("test/first/app/firstapp")
								}
							}
						}
					}
